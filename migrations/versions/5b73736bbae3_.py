...
Revision ID: 5b73736bbae3
Revises: 1131f718de75
Create Date: 2021-10-21 03:35:01.595417
...
revision = '5b73736bbae3'
down_revision = '1131f718de75'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.ForeignKeyConstraint(['people_id'], ['people.id'], name='favoritespeople_ibfk_1'),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], name='favoritespeople_ibfk_2'),
    sa.PrimaryKeyConstraint('id', 'user_id', 'people_id'),
